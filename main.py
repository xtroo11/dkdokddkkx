...
def start(message):
	...
	if f == SUDO:
		...
		M = types.InlineKeyboardButton('DEV', url='https://t.me/III7H')
		mas.add(G,K)
		mas.add(V)
		mas.add(M)
		...
		me = types.InlineKeyboardButton(text="دنجب",url="https://t.me/JJ8JJ8")
		he = types.InlineKeyboardButton(text="دنجب",url="https://t.me/JJ8JJ8")
		de = types.InlineKeyboardButton(text="دراكون",url="https://t.me/s_l_3")
		ch = types.InlineKeyboardButton(text="▶ قناة البوت ◀",url="https://t.me/JJ8JJ8")
		rr.add(me,he,de)
		rr.add(ch)
...
def masg(call):
	...
	if call.data =="III7H":
		...
		M = types.InlineKeyboardButton('DEV', url='https://t.me/JJ8JJ8')
